...
const SocialLogin = () => {
    ...
    return (
        <div className="px-10">
            ...
            <div className="">
                <button onClick={handleGoogleLogin} className="btn border shadow-none border-gray-300 text-lg w-full"><FcGoogle size={24} /><span>Login with Google</span></button>
            </div>
            <div className="divider mx-32 my-3">OR</div>
            <div className="">
